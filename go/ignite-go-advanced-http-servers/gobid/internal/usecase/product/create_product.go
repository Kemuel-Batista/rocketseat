...
func (req CreateProductUseCaseRequest) Valid(ctx context.Context) validator.Evaluator {
	...
	eval.CheckField(req.AuctionEnd.Sub(time.Now()) >= minAuctionDuration, "auction_end", "must be at least 2 hours from now")
